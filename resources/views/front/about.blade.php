						...
						<div class="about-us-content-item">
							...
							<div class="row" data-aos="fade-left" data-aos-duration="1000">
								...
								<div class="col-md-5 m-auto">
									<img src="{{asset('front_assets/img/about/abt-11.jpg')}}" class="img-fluid br-30">
								</div>
							</div>

							<div class="row my-3" data-aos="fade-left" data-aos-duration="1200">

								<div class="col-md-5 m-auto">
									<img src="{{asset('front_assets/img/about/abt-22.jpg')}}" class="img-fluid br-30">
								</div>
							...
							<div class="row" data-aos="fade-right" data-aos-duration="1000">
								...
								<div class="col-md-7 m-auto">
									...
									<div class="about-text-item">
										<div class="section-title-2  headline text-left mt-2">
											<h2>Our <span>Mission</span></h2>
										</div>
										<p>
											To provide practical blended training experiences capable of directly impacting the business ecosystem through well-designed courses and workshops delivered by our experienced LD Department and expert trainers to fit the needs of different businesses. 
										</p>
									</div>
								</div>
					...
					<div class="col-md-9">
						<div class="about-us-content-item">
							...
							<div class="about-text-item text-center">
								<p class="text-white"  style="border: 2px solid #fccb41;border-radius: 0px 50px;padding: 15px;background: #0190d0;" data-aos="fade-up" data-aos-duration="1000">
								...
								<p class="text-white"  style="border: 2px solid #fff;border-radius: 0px 50px;padding: 15px;background: #fccb41;" data-aos="fade-up" data-aos-duration="1000">
								...
								<p class="text-white"  style="border: 2px solid #fccb41;border-radius: 0px 50px;padding: 15px;background: #06528b;" data-aos="fade-up" data-aos-duration="1000">
