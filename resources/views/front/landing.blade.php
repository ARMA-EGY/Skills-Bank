                ...
                <div class="navbar-header">
                    ...
                    <a href="#">
                        <div class="logo-container">
                            <div class="logo">
                                <img src="{{ asset('landing_assets/img/new_logo.png') }}" alt="Logo">
                            </div>
                        </div>
                    </a>
                </div>
        ...
        <div class="wrapper">
            <div class="parallax filter-gradient blue" data-color="blue">
                <div class="parallax-background">
                    <img class="parallax-background-image" src="{{ asset('landing_assets/img/template/bg3.jpg') }}">
                </div>
                <div class= "container">
                    <div class="row">
                        <div class="col-md-5 hidden-xs">
                            <div class="parallax-image">
                                <img class="phone" src="{{ asset('landing_assets/img/template/iphone3.png') }}" style="margin-top: 20px"/>
                            </div>
                        </div>
                ...
                <div class="container text-center">
                    ...
                    <div class="logos">
                        <ul class="list-unstyled">
                            <li ><img src="{{ asset('landing_assets/img/logos/adobe.png') }}"/></li>
                            <li ><img src="{{ asset('landing_assets/img/logos/zendesk.png') }}"/></li>
                            <li ><img src="{{ asset('landing_assets/img/logos/ebay.png') }}"/></i>
                            <li ><img src="{{ asset('landing_assets/img/logos/evernote.png') }}"/></li>
                            <li ><img src="{{ asset('landing_assets/img/logos/airbnb.png') }}"/></li>
                            <li ><img src="{{ asset('landing_assets/img/logos/zappos.png') }}"/></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-5 col-md-offset-1 hidden-xs">
                            <img src="{{ asset('landing_assets/img/template/mac.png') }}"/>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <div id="description-carousel" class="carousel fade" data-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="item">
                                        <img src="{{ asset('landing_assets/img/template/examples/home_33.jpg') }}" alt="">
                                    </div>
                                    <div class="item active">
                                        <img src="{{ asset('landing_assets/img/template/examples/home_22.jpg') }}" alt="">
                                    </div>
                                    <div class="item">
                                        <img src="{{ asset('landing_assets/img/template/examples/home_11.jpg') }}" alt="">
                                    </div>
                                </div>
                        ...
                        <div class="col-md-5 col-md-offset-1">
                            ...
                            <a href="#" id="Demo3" class="btn btn-fill btn-info" data-button="info">Explore More</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="container">
                    ...
                    <div id="carousel-example-generic" class="carousel fade" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item">
                                <div class="mask">
                                    <img src="{{ asset('landing_assets/img/faces/face-4.jpg') }}">
                                </div>
                            ...
                            <div class="item active">
                                <div class="mask">
                                    <img src="{{ asset('landing_assets/img/faces/face-3.jpg') }}">
                                </div>
                                <div class="carousel-testimonial-caption">
                                    <p>Drake, Artist</p>
                            ...
                            <div class="item">
                                <div class="mask">
                                    <img src="{{ asset('landing_assets/img/faces/face-2.jpg') }}">
                                </div>
                                <div class="carousel-testimonial-caption">
            ...
            <div class="section section-no-padding">
                <div class="parallax filter-gradient blue" data-color="blue">
                    ...
                    <div class="info">
                        ...
                        <p>Beautiful multipurpose landing page.</p>
                        <a href="#" class="btn btn-neutral btn-lg btn-fill">Contact Us</a>
                    </div>
                </div>
            </div>
            <footer class="footer">
