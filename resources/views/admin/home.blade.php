              ...
              <div class="col-xl-3 col-md-6">
                <div class="card card-stats">
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col">
                        <h5 class="card-title text-uppercase text-muted mb-0">Careers</h5>
                        <span class="h2 font-weight-bold mb-0">{{$careers_count}}</span>
                      </div>
                      <div class="col-auto">
              ...
              <div class="col-xl-3 col-md-6">
                <div class="card card-stats">
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col">
                        <h5 class="card-title text-uppercase text-muted mb-0">Collaborations</h5>
                        <span class="h2 font-weight-bold mb-0">{{$collaborations_count}}</span>
                      </div>
                      <div class="col-auto">
