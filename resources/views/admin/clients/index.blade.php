        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
              <a href="{{ route('clients.create')}}" class="btn btn-sm btn-neutral"><i class="fa fa-plus"></i> New Client</a>
            </div>
          ...
          <div class="card">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">All Clients  <span class="badge badge-primary p-2">{{$clients_count}}</span></h3>
                </div>
              </div>
            </div>
