                    ...
                    <td >
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                          <a href="{{ route('collaboration.edit', $draft->id)}}" class="dropdown-item"><i class="fa fa-edit text-success"></i> Edit</a>
                          <button class="dropdown-item remove_item" data-id="{{$draft->id}}" data-url="{{route('remove-collaboration')}}"><i class="fa fa-trash-alt text-danger"></i> Remove</button>
