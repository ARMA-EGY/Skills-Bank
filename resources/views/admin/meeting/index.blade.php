        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
              <a href="{{ route('meetings.create')}}" class="btn btn-sm btn-neutral"><i class="fa fa-plus"></i> New Meeting</a>
            </div>
          ...
          <div class="card">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">All Meetings  <span class="badge badge-primary p-2">{{$meetings_count}}</span></h3>
                </div>
              </div>
            </div>
            ...
            @else 
                <p class="text-center"> No Meetings Available.</p>
            @endif
