...
@section('content')
            ...
            <div class="col-lg-12 text-left">
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item"><a href="{{route('clientscategory.index')}}">Client Categories</a></li>
    ...
    <div class="container-fluid mt--6">
      ...
      <form action="{{ isset($item) ? route('clientscategory.update', $item->id) : route('clientscategory.store')  }}" method="post" enctype="multipart/form-data">
        @csrf
