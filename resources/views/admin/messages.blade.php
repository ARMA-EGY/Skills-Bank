            ...
            <div class="col-lg-6 col-7 text-left">
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">{{__('master.MESSAGES')}}</li>
                </ol>
              </nav>
            </div>
            <div class="col-lg-6 col-5 text-right">
              <a href="#" class="btn btn-sm btn-neutral get_receiver_email"> {{__('master.RECIPIENT-EMAIL')}}</a>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="grid email">
            <div class="grid-body">
              <div class="row">
                <!-- BEGIN INBOX MENU -->
                <div class="col-md-3">
                  <h2 class="grid-title"><i class="fa fa-inbox"></i> {{__('master.INBOX')}}</h2>
                  ...
                  <div>
                    <ul class="nav nav-pills nav-stacked">
                      <li class="active"><a href="#"><i class="fa fa-inbox"></i> {{__('master.INBOX')}} ({{$messages->total()}})</a></li>
                    </ul>
                  </div>
                </div>
                <!-- END INBOX MENU -->
